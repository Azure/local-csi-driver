...
type Interface interface {
	...
	IsFormatted(device string) (string, bool, error)
}
...
// IsFormatted reports whether the given block device is formatted and returns its filesystem type if present.
...
func (s *block) IsFormatted(blockDev string) (string, bool, error) {
